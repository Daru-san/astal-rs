...
impl ::std::fmt::Debug for AstalButton {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("AstalButton @ {self:p}")).finish()
    }
}
...
impl ::std::fmt::Debug for AstalIcon {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("AstalIcon @ {self:p}")).finish()
    }
}
...
impl ::std::fmt::Debug for AstalLabel {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("AstalLabel @ {self:p}")).finish()
    }
}
...
impl ::std::fmt::Debug for AstalOverlay {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("AstalOverlay @ {self:p}")).finish()
    }
}
...
impl ::std::fmt::Debug for AstalStack {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("AstalStack @ {self:p}")).finish()
    }
}
...
extern "C" {
    ...
    pub fn astal_center_box_set_start_widget(
        self_: *mut AstalCenterBox,
    ...
    pub fn astal_center_box_set_center_widget(
        self_: *mut AstalCenterBox,
        value: *mut gtk::GtkWidget,
    );
    ...
    pub fn astal_icon_get_pixbuf(self_: *mut AstalIcon) -> *mut gdk_pixbuf::Pixbuf;
    pub fn astal_icon_set_pixbuf(self_: *mut AstalIcon, value: *mut gdk_pixbuf::Pixbuf);
    ...
    pub fn astal_widget_set_class_names(
        widget: *mut gtk::GtkWidget,
        class_names: *mut *mut c_char,
        class_names_length1: c_int,
    );
    pub fn astal_widget_get_class_names(widget: *mut gtk::GtkWidget) -> *mut glib::GList;
    pub fn astal_widget_toggle_class_name(
        widget: *mut gtk::GtkWidget,
