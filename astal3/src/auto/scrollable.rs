...
pub struct ScrollableBuilder {
    ...
    pub fn propagate_natural_width(self, propagate_natural_width: bool) -> Self {
                            ...
                            //pub fn shadow_type(self, shadow_type: /*Ignored*/gtk::ShadowType) -> Self {
                        ...
                        //}
                            ...
                            //pub fn window_placement(self, window_placement: /*Ignored*/gtk::CornerType) -> Self {
...
pub trait ScrollableExt: IsA<Scrollable> + 'static {
    ...
    fn connect_hscroll_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, c"notify::hscroll".as_ptr() as *const _,
    ...
    fn connect_vscroll_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, c"notify::vscroll".as_ptr() as *const _,
