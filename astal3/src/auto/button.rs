...
//    #[cfg_attr(feature = "v3_10", deprecated = "Since 3.10")]
    //pub fn related_action(self, related_action: &impl IsA</*Ignored*/gtk::Action>) -> Self {
                        //    Self { builder: self.builder.property("related-action", related_action.clone().upcast()), }
                        //}

                            #[cfg(feature = "gtk_v2_16")]
    #[cfg_attr(docsrs, doc(cfg(feature = "gtk_v2_16")))]
    #[cfg_attr(feature = "v3_10", deprecated = "Since 3.10")]
    pub fn use_action_appearance(self, use_action_appearance: bool) -> Self {
                            Self { builder: self.builder.property("use-action-appearance", use_action_appearance), }
                        }
...
pub trait ButtonExt: IsA<Button> + 'static {
    ...
    fn connect_hover<F: Fn(&Self, &HoverEvent) + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, c"hover".as_ptr() as *const _,
    ...
    fn connect_hover_lost<F: Fn(&Self, &HoverEvent) + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, c"hover-lost".as_ptr() as *const _,
    ...
    fn connect_click<F: Fn(&Self, &ClickEvent) + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, c"click".as_ptr() as *const _,
    ...
    fn connect_click_release<F: Fn(&Self, &ClickEvent) + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, c"click-release".as_ptr() as *const _,
    ...
    fn connect_scroll<F: Fn(&Self, &ScrollEvent) + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, c"scroll".as_ptr() as *const _,
