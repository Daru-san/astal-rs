...
pub trait CenterBoxExt: IsA<CenterBox> + 'static {
    ...
    fn start_widget(&self) -> gtk::Widget {
        unsafe {
    ...
    fn center_widget(&self) -> gtk::Widget {
        unsafe {
    ...
    fn connect_start_widget_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, c"notify::start-widget".as_ptr() as *const _,
    ...
    fn connect_end_widget_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, c"notify::end-widget".as_ptr() as *const _,
    ...
    fn connect_center_widget_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, c"notify::center-widget".as_ptr() as *const _,
