...
pub struct SliderBuilder {
    ...
    pub fn fill_level(self, fill_level: f64) -> Self {
                            ...
                            //pub fn lower_stepper_sensitivity(self, lower_stepper_sensitivity: /*Ignored*/gtk::SensitivityType) -> Self {
    ...
    pub fn show_fill_level(self, show_fill_level: bool) -> Self {
                            ...
                            //pub fn upper_stepper_sensitivity(self, upper_stepper_sensitivity: /*Ignored*/gtk::SensitivityType) -> Self {
...
pub trait SliderExt: IsA<Slider> + 'static {
    ...
    fn connect_dragged<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, c"dragged".as_ptr() as *const _,
    ...
    fn connect_vertical_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, c"notify::vertical".as_ptr() as *const _,
    ...
    fn connect_dragging_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, c"notify::dragging".as_ptr() as *const _,
    ...
    fn connect_value_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, c"notify::value".as_ptr() as *const _,
    ...
    fn connect_min_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, c"notify::min".as_ptr() as *const _,
    ...
    fn connect_max_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, c"notify::max".as_ptr() as *const _,
    ...
    fn connect_step_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, c"notify::step".as_ptr() as *const _,
