...
pub trait ApplicationExt: IsA<Application> + 'static {
    ...
    fn request(&self, request: &str, conn: &impl IsA<gio::SocketConnection>) {
        unsafe {
            ffi::astal_application_request(self.as_ref().to_glib_none().0, request.to_glib_none().0, conn.as_ref().to_glib_none().0);
        }
    }
    ...
    fn connect_monitor_added<F: Fn(&Self, &gdk::Monitor) + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, c"monitor-added".as_ptr() as *const _,
    ...
    fn connect_monitor_removed<F: Fn(&Self, &gdk::Monitor) + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, c"monitor-removed".as_ptr() as *const _,
    ...
    fn connect_window_toggled<F: Fn(&Self, &gtk::Window) + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, c"window-toggled".as_ptr() as *const _,
    ...
    fn connect_monitors_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, c"notify::monitors".as_ptr() as *const _,
    ...
    fn connect_gtk_theme_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, c"notify::gtk-theme".as_ptr() as *const _,
    ...
    fn connect_icon_theme_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, c"notify::icon-theme".as_ptr() as *const _,
    ...
    fn connect_cursor_theme_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, c"notify::cursor-theme".as_ptr() as *const _,
