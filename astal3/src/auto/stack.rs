...
pub struct StackBuilder {
    ...
    pub fn hhomogeneous(self, hhomogeneous: bool) -> Self {
                            ...
                            //pub fn transition_type(self, transition_type: /*Ignored*/gtk::StackTransitionType) -> Self {
...
pub trait StackExt: IsA<Stack> + 'static {
    ...
    fn connect_shown_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, c"notify::shown".as_ptr() as *const _,
    ...
    fn connect_children_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, c"notify::children".as_ptr() as *const _,
