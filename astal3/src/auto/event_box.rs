...
pub struct EventBoxBuilder {
            builder: glib::object::ObjectBuilder<'static, EventBox>,
        }
        ...
        fn new() -> Self {
            Self { builder: glib::object::Object::builder() }
                            ...
                            Self { builder: self.builder.property("above-child", above_child), }
                        }

                            pub fn visible_window(self, visible_window: bool) -> Self {
                            Self { builder: self.builder.property("visible-window", visible_window), }
                        }
...
pub trait EventBoxExt: IsA<EventBox> + 'static {
    ...
    fn connect_motion<F: Fn(&Self, &MotionEvent) + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, c"motion".as_ptr() as *const _,
