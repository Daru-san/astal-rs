...
extern "C" {
    ...
    pub fn astal_tray_tray_get_item(
        self_: *mut AstalTrayTray,
        item_id: *const c_char,
    ) -> *mut AstalTrayTrayItem;
    pub fn astal_tray_tray_new() -> *mut AstalTrayTray;
    pub fn astal_tray_tray_get_items(self_: *mut AstalTrayTray) -> *mut glib::GList;
    pub fn astal_tray_tray_get_items_model(self_: *mut AstalTrayTray) -> *mut gio::GListModel;

    //=========================================================================
    // AstalTrayTrayItem
    //=========================================================================
    pub fn astal_tray_tray_item_get_type() -> GType;
    pub fn astal_tray_tray_item_about_to_show(self_: *mut AstalTrayTrayItem);
    pub fn astal_tray_tray_item_activate(self_: *mut AstalTrayTrayItem, x: c_int, y: c_int);
    pub fn astal_tray_tray_item_secondary_activate(
        self_: *mut AstalTrayTrayItem,
        x: c_int,
        y: c_int,
    );
    pub fn astal_tray_tray_item_scroll(
        self_: *mut AstalTrayTrayItem,
        delta: c_int,
        orientation: *const c_char,
    );
    pub fn astal_tray_tray_item_to_json_string(self_: *mut AstalTrayTrayItem) -> *mut c_char;
    pub fn astal_tray_tray_item_get_title(self_: *mut AstalTrayTrayItem) -> *const c_char;
    ...
    pub fn astal_tray_tray_item_get_tooltip(self_: *mut AstalTrayTrayItem)
        -> *mut AstalTrayTooltip;
    pub fn astal_tray_tray_item_get_tooltip_markup(self_: *mut AstalTrayTrayItem) -> *mut c_char;
    pub fn astal_tray_tray_item_get_tooltip_text(self_: *mut AstalTrayTrayItem) -> *mut c_char;
    pub fn astal_tray_tray_item_get_id(self_: *mut AstalTrayTrayItem) -> *const c_char;
    pub fn astal_tray_tray_item_get_is_menu(self_: *mut AstalTrayTrayItem) -> gboolean;
    pub fn astal_tray_tray_item_get_icon_theme_path(self_: *mut AstalTrayTrayItem)
        -> *const c_char;
    pub fn astal_tray_tray_item_get_icon_name(self_: *mut AstalTrayTrayItem) -> *mut c_char;
    pub fn astal_tray_tray_item_get_icon_pixbuf(
        self_: *mut AstalTrayTrayItem,
    ...
    pub fn astal_tray_tray_item_get_menu_path(self_: *mut AstalTrayTrayItem) -> *const c_char;
    pub fn astal_tray_tray_item_get_menu_model(
        self_: *mut AstalTrayTrayItem,
    ) -> *mut gio::GMenuModel;
    pub fn astal_tray_tray_item_get_action_group(
        self_: *mut AstalTrayTrayItem,
    ...
    pub fn astal_tray_category_from_string(
        value: *const c_char,
        error: *mut *mut glib::GError,
    ) -> AstalTrayCategory;
    pub fn astal_tray_status_to_nick(self_: AstalTrayStatus) -> *mut c_char;
    pub fn astal_tray_status_from_string(
        value: *const c_char,
        error: *mut *mut glib::GError,
    ) -> AstalTrayStatus;
