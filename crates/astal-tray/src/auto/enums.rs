...
impl Category {
    ...
    pub fn to_nick(&self) -> String {
        crate::functions::category_to_nick(self).to_string()
    }
}
...
impl FromStr for Category {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        crate::functions::category_from_string(s)
    }
}
...
impl Status {
    ...
    pub fn to_nick(&self) -> String {
        crate::functions::status_to_nick(self).to_string()
    }
}
...
impl FromStr for Status {
    type Err = glib::Error;
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        crate::functions::status_from_string(s)
    }
}
