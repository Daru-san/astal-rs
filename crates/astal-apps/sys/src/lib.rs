...
extern "C" {
    ...
    pub fn astal_apps_application_get_key(
        self_: *mut AstalAppsApplication,
        key: *const c_char,
    ) -> *mut c_char;
    pub fn astal_apps_application_launch(self_: *mut AstalAppsApplication) -> gboolean;
    pub fn astal_apps_application_fuzzy_match(
        self_: *mut AstalAppsApplication,
        term: *const c_char,
        result: *mut AstalAppsScore,
    );
    pub fn astal_apps_application_exact_match(
        self_: *mut AstalAppsApplication,
        term: *const c_char,
        result: *mut AstalAppsScore,
    );
    pub fn astal_apps_application_get_app(
        self_: *mut AstalAppsApplication,
    ) -> *mut gio_unix::GDesktopAppInfo;
    pub fn astal_apps_application_set_app(
        self_: *mut AstalAppsApplication,
        value: *mut gio_unix::GDesktopAppInfo,
    );
    ...
    pub fn astal_apps_application_get_description(
        self_: *mut AstalAppsApplication,
    ) -> *const c_char;
    ...
    pub fn astal_apps_application_get_keywords(
        self_: *mut AstalAppsApplication,
        result_length1: *mut c_int,
    ) -> *mut *mut c_char;
    pub fn astal_apps_application_get_categories(
        self_: *mut AstalAppsApplication,
        result_length1: *mut c_int,
    ) -> *mut *mut c_char;
    ...
    pub fn astal_apps_apps_fuzzy_score(
        self_: *mut AstalAppsApps,
        search: *const c_char,
        a: *mut AstalAppsApplication,
    ) -> c_double;
    pub fn astal_apps_apps_exact_score(
        self_: *mut AstalAppsApps,
        search: *const c_char,
        a: *mut AstalAppsApplication,
    ) -> c_double;
    pub fn astal_apps_apps_fuzzy_query(
        self_: *mut AstalAppsApps,
        search: *const c_char,
    ) -> *mut glib::GList;
    pub fn astal_apps_apps_exact_query(
        self_: *mut AstalAppsApps,
        search: *const c_char,
    ) -> *mut glib::GList;
