...
use crate::{ffi,Device,Endpoint,Stream,Wp};
...
impl Video {
    ...
    pub fn connect_recorder_added<F: Fn(&Self, &Stream) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn recorder_added_trampoline<F: Fn(&Video, &Stream) + 'static>(this: *mut ffi::AstalWpVideo, object: *mut ffi::AstalWpStream, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(&from_glib_borrow(this), &from_glib_borrow(object))
        }
        unsafe {
    ...
    pub fn connect_recorder_removed<F: Fn(&Self, &Stream) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn recorder_removed_trampoline<F: Fn(&Video, &Stream) + 'static>(this: *mut ffi::AstalWpVideo, object: *mut ffi::AstalWpStream, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(&from_glib_borrow(this), &from_glib_borrow(object))
        }
        unsafe {
    ...
    pub fn connect_sink_added<F: Fn(&Self, &Endpoint) + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, c"sink-added".as_ptr() as *const _,
    ...
    pub fn connect_sink_removed<F: Fn(&Self, &Endpoint) + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, c"sink-removed".as_ptr() as *const _,
    ...
    pub fn connect_source_added<F: Fn(&Self, &Endpoint) + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, c"source-added".as_ptr() as *const _,
    ...
    pub fn connect_source_removed<F: Fn(&Self, &Endpoint) + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, c"source-removed".as_ptr() as *const _,
    ...
    pub fn connect_stream_added<F: Fn(&Self, &Stream) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn stream_added_trampoline<F: Fn(&Video, &Stream) + 'static>(this: *mut ffi::AstalWpVideo, object: *mut ffi::AstalWpStream, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(&from_glib_borrow(this), &from_glib_borrow(object))
        }
        unsafe {
    ...
    pub fn connect_stream_removed<F: Fn(&Self, &Stream) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn stream_removed_trampoline<F: Fn(&Video, &Stream) + 'static>(this: *mut ffi::AstalWpVideo, object: *mut ffi::AstalWpStream, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(&from_glib_borrow(this), &from_glib_borrow(object))
        }
        unsafe {
    ...
    pub fn connect_sinks_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, c"notify::sinks".as_ptr() as *const _,
    ...
    pub fn connect_sources_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, c"notify::sources".as_ptr() as *const _,
