...
pub struct AstalBluetoothBluetoothClass {
    pub parent_class: gobject::GObjectClass,
    pub device_added:
        Option<unsafe extern "C" fn(*mut AstalBluetoothBluetooth, *mut AstalBluetoothDevice)>,
    pub device_removed:
        Option<unsafe extern "C" fn(*mut AstalBluetoothBluetooth, *mut AstalBluetoothDevice)>,
    pub adapter_added:
        Option<unsafe extern "C" fn(*mut AstalBluetoothBluetooth, *mut AstalBluetoothAdapter)>,
    pub adapter_removed:
        Option<unsafe extern "C" fn(*mut AstalBluetoothBluetooth, *mut AstalBluetoothAdapter)>,
}
...
extern "C" {
    ...
    pub fn astal_bluetooth_adapter_remove_device(
        self_: *mut AstalBluetoothAdapter,
        device: *mut AstalBluetoothDevice,
        error: *mut *mut glib::GError,
    );
    pub fn astal_bluetooth_adapter_start_discovery(
        self_: *mut AstalBluetoothAdapter,
        error: *mut *mut glib::GError,
    );
    pub fn astal_bluetooth_adapter_stop_discovery(
        self_: *mut AstalBluetoothAdapter,
        error: *mut *mut glib::GError,
    );
    pub fn astal_bluetooth_adapter_get_uuids(
        self_: *mut AstalBluetoothAdapter,
    ...
    pub fn astal_bluetooth_adapter_set_discoverable(
        self_: *mut AstalBluetoothAdapter,
        value: gboolean,
    );
    ...
    pub fn astal_bluetooth_adapter_set_alias(
        self_: *mut AstalBluetoothAdapter,
        value: *const c_char,
    );
    pub fn astal_bluetooth_adapter_get_discoverable_timeout(
        self_: *mut AstalBluetoothAdapter,
    ) -> c_uint;
    pub fn astal_bluetooth_adapter_set_discoverable_timeout(
        self_: *mut AstalBluetoothAdapter,
        value: c_uint,
    );
    pub fn astal_bluetooth_adapter_get_pairable_timeout(
        self_: *mut AstalBluetoothAdapter,
    ) -> c_uint;
    pub fn astal_bluetooth_adapter_set_pairable_timeout(
        self_: *mut AstalBluetoothAdapter,
        value: c_uint,
    );
    ...
    pub fn astal_bluetooth_bluetooth_get_is_powered(
        self_: *mut AstalBluetoothBluetooth,
    ) -> gboolean;
    pub fn astal_bluetooth_bluetooth_get_is_connected(
        self_: *mut AstalBluetoothBluetooth,
    ) -> gboolean;
    pub fn astal_bluetooth_bluetooth_get_adapter(
        self_: *mut AstalBluetoothBluetooth,
    ) -> *mut AstalBluetoothAdapter;
    pub fn astal_bluetooth_bluetooth_get_adapters(
        self_: *mut AstalBluetoothBluetooth,
    ) -> *mut glib::GList;
    pub fn astal_bluetooth_bluetooth_get_devices(
        self_: *mut AstalBluetoothBluetooth,
    ) -> *mut glib::GList;
    ...
    pub fn astal_bluetooth_device_connect_device(
        self_: *mut AstalBluetoothDevice,
        _callback_: gio::GAsyncReadyCallback,
        _callback__target: *mut c_void,
    );
    pub fn astal_bluetooth_device_connect_device_finish(
        self_: *mut AstalBluetoothDevice,
        _res_: *mut gio::GAsyncResult,
        error: *mut *mut glib::GError,
    );
    pub fn astal_bluetooth_device_disconnect_device(
        self_: *mut AstalBluetoothDevice,
        _callback_: gio::GAsyncReadyCallback,
        _callback__target: *mut c_void,
    );
    pub fn astal_bluetooth_device_disconnect_device_finish(
        self_: *mut AstalBluetoothDevice,
        _res_: *mut gio::GAsyncResult,
        error: *mut *mut glib::GError,
    );
    pub fn astal_bluetooth_device_connect_profile(
        self_: *mut AstalBluetoothDevice,
        uuid: *const c_char,
        error: *mut *mut glib::GError,
    );
    pub fn astal_bluetooth_device_disconnect_profile(
        self_: *mut AstalBluetoothDevice,
        uuid: *const c_char,
        error: *mut *mut glib::GError,
    );
    pub fn astal_bluetooth_device_pair(
        self_: *mut AstalBluetoothDevice,
        error: *mut *mut glib::GError,
    );
    pub fn astal_bluetooth_device_cancel_pairing(
        self_: *mut AstalBluetoothDevice,
        error: *mut *mut glib::GError,
    );
    pub fn astal_bluetooth_device_get_uuids(
        self_: *mut AstalBluetoothDevice,
        result_length1: *mut c_int,
    ) -> *mut *mut c_char;
    ...
    pub fn astal_bluetooth_device_get_battery_percentage(
        self_: *mut AstalBluetoothDevice,
    ) -> c_double;
