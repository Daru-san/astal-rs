...
impl std::fmt::Display for Workspace {
    ...
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.write_str(&WorkspaceExt::name(self))
    }
}
...
pub trait WorkspaceExt: IsA<Workspace> + 'static {
    ...
    fn connect_clients_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, c"notify::clients".as_ptr() as *const _,
    ...
    fn connect_has_fullscreen_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, c"notify::has-fullscreen".as_ptr() as *const _,
    ...
    fn connect_last_client_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, c"notify::last-client".as_ptr() as *const _,
