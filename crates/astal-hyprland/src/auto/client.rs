...
use crate::{Fullscreen, Monitor, Workspace, ffi};
use glib::{
...
impl Client {
    ...
    pub fn new() -> Client {
        ...
        unsafe { from_glib_full(ffi::astal_hyprland_client_new()) }
    }
...
impl ClientBuilder {
    ...
    pub fn address(self, address: impl Into<glib::GString>) -> Self {
        Self {
            builder: self.builder.property("address", address.into()),
        }
    }

    pub fn mapped(self, mapped: bool) -> Self {
        Self {
            builder: self.builder.property("mapped", mapped),
        }
    }
    ...
    pub fn workspace(self, workspace: &impl IsA<Workspace>) -> Self {
        Self {
            builder: self
                .builder
                .property("workspace", workspace.clone().upcast()),
        }
    }

    pub fn floating(self, floating: bool) -> Self {
        Self {
            builder: self.builder.property("floating", floating),
        }
    }

    pub fn monitor(self, monitor: &impl IsA<Monitor>) -> Self {
        Self {
            builder: self.builder.property("monitor", monitor.clone().upcast()),
        }
    }

    pub fn class(self, class: impl Into<glib::GString>) -> Self {
        Self {
            builder: self.builder.property("class", class.into()),
        }
    }
    ...
    pub fn initial_class(self, initial_class: impl Into<glib::GString>) -> Self {
        Self {
            builder: self.builder.property("initial-class", initial_class.into()),
        }
    }

    pub fn initial_title(self, initial_title: impl Into<glib::GString>) -> Self {
        Self {
            builder: self.builder.property("initial-title", initial_title.into()),
        }
    }

    pub fn pid(self, pid: u32) -> Self {
        Self {
            builder: self.builder.property("pid", pid),
        }
    }

    pub fn xwayland(self, xwayland: bool) -> Self {
        Self {
            builder: self.builder.property("xwayland", xwayland),
        }
    }
    ...
    pub fn fullscreen_client(self, fullscreen_client: Fullscreen) -> Self {
        Self {
            builder: self
                .builder
                .property("fullscreen-client", fullscreen_client),
        }
    }

    pub fn swallowing(self, swallowing: impl Into<glib::GString>) -> Self {
        Self {
            builder: self.builder.property("swallowing", swallowing.into()),
        }
    }

    pub fn focus_history_id(self, focus_history_id: i32) -> Self {
        Self {
            builder: self.builder.property("focus-history-id", focus_history_id),
        }
    }
...
pub trait ClientExt: IsA<Client> + 'static {
    ...
    fn move_to(&self, ws: &impl IsA<Workspace>) {
        unsafe {
            ffi::astal_hyprland_client_move_to(
                self.as_ref().to_glib_none().0,
                ws.as_ref().to_glib_none().0,
            );
        }
    }
    ...
    fn address(&self) -> glib::GString {
        unsafe {
            from_glib_none(ffi::astal_hyprland_client_get_address(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn is_mapped(&self) -> bool {
        unsafe {
            from_glib(ffi::astal_hyprland_client_get_mapped(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn is_hidden(&self) -> bool {
        unsafe {
            from_glib(ffi::astal_hyprland_client_get_hidden(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    #[doc(alias = "get_x")]
    fn x(&self) -> i32 {
        unsafe { ffi::astal_hyprland_client_get_x(self.as_ref().to_glib_none().0) }
    }

    #[doc(alias = "astal_hyprland_client_get_y")]
    #[doc(alias = "get_y")]
    fn y(&self) -> i32 {
        unsafe { ffi::astal_hyprland_client_get_y(self.as_ref().to_glib_none().0) }
    }

    #[doc(alias = "astal_hyprland_client_get_width")]
    #[doc(alias = "get_width")]
    fn width(&self) -> i32 {
        unsafe { ffi::astal_hyprland_client_get_width(self.as_ref().to_glib_none().0) }
    }

    #[doc(alias = "astal_hyprland_client_get_height")]
    #[doc(alias = "get_height")]
    fn height(&self) -> i32 {
        unsafe { ffi::astal_hyprland_client_get_height(self.as_ref().to_glib_none().0) }
    }
    ...
    fn workspace(&self) -> Workspace {
        unsafe {
            from_glib_none(ffi::astal_hyprland_client_get_workspace(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn is_floating(&self) -> bool {
        unsafe {
            from_glib(ffi::astal_hyprland_client_get_floating(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn monitor(&self) -> Monitor {
        unsafe {
            from_glib_none(ffi::astal_hyprland_client_get_monitor(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn class(&self) -> glib::GString {
        unsafe {
            from_glib_none(ffi::astal_hyprland_client_get_class(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn title(&self) -> glib::GString {
        unsafe {
            from_glib_none(ffi::astal_hyprland_client_get_title(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn initial_class(&self) -> glib::GString {
        unsafe {
            from_glib_none(ffi::astal_hyprland_client_get_initial_class(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn initial_title(&self) -> glib::GString {
        unsafe {
            from_glib_none(ffi::astal_hyprland_client_get_initial_title(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    #[doc(alias = "get_pid")]
    fn pid(&self) -> u32 {
        unsafe { ffi::astal_hyprland_client_get_pid(self.as_ref().to_glib_none().0) }
    }
    ...
    fn is_xwayland(&self) -> bool {
        unsafe {
            from_glib(ffi::astal_hyprland_client_get_xwayland(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn is_pinned(&self) -> bool {
        unsafe {
            from_glib(ffi::astal_hyprland_client_get_pinned(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn fullscreen(&self) -> Fullscreen {
        unsafe {
            from_glib(ffi::astal_hyprland_client_get_fullscreen(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn fullscreen_client(&self) -> Fullscreen {
        unsafe {
            from_glib(ffi::astal_hyprland_client_get_fullscreen_client(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn swallowing(&self) -> glib::GString {
        unsafe {
            from_glib_none(ffi::astal_hyprland_client_get_swallowing(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn focus_history_id(&self) -> i32 {
        unsafe { ffi::astal_hyprland_client_get_focus_history_id(self.as_ref().to_glib_none().0) }
    }
    ...
    fn connect_removed<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn removed_trampoline<P: IsA<Client>, F: Fn(&P) + 'static>(
            this: *mut ffi::AstalHyprlandClient,
            f: glib::ffi::gpointer,
        ) {
            unsafe {
    ...
    fn connect_moved_to<F: Fn(&Self, &Workspace) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn moved_to_trampoline<
            P: IsA<Client>,
        ...
        unsafe {
            ...
            connect_raw(
                self.as_ptr() as *mut _,
                c"moved-to".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(
                    moved_to_trampoline::<Self, F> as *const (),
                )),
                Box_::into_raw(f),
            )
        }
    ...
    fn connect_address_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_address_trampoline<P: IsA<Client>, F: Fn(&P) + 'static>(
            this: *mut ffi::AstalHyprlandClient,
    ...
    fn connect_mapped_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_mapped_trampoline<P: IsA<Client>, F: Fn(&P) + 'static>(
            this: *mut ffi::AstalHyprlandClient,
            _param_spec: glib::ffi::gpointer,
            f: glib::ffi::gpointer,
        ) {
    ...
    fn connect_hidden_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_hidden_trampoline<P: IsA<Client>, F: Fn(&P) + 'static>(
            this: *mut ffi::AstalHyprlandClient,
            _param_spec: glib::ffi::gpointer,
            f: glib::ffi::gpointer,
        ) {
    ...
    fn connect_x_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_x_trampoline<P: IsA<Client>, F: Fn(&P) + 'static>(
            this: *mut ffi::AstalHyprlandClient,
            _param_spec: glib::ffi::gpointer,
            f: glib::ffi::gpointer,
        ) {
    ...
    fn connect_y_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_y_trampoline<P: IsA<Client>, F: Fn(&P) + 'static>(
            this: *mut ffi::AstalHyprlandClient,
            _param_spec: glib::ffi::gpointer,
            f: glib::ffi::gpointer,
        ) {
    ...
    fn connect_width_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_width_trampoline<P: IsA<Client>, F: Fn(&P) + 'static>(
            this: *mut ffi::AstalHyprlandClient,
            _param_spec: glib::ffi::gpointer,
            f: glib::ffi::gpointer,
        ) {
    ...
    fn connect_height_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_height_trampoline<P: IsA<Client>, F: Fn(&P) + 'static>(
            this: *mut ffi::AstalHyprlandClient,
            _param_spec: glib::ffi::gpointer,
            f: glib::ffi::gpointer,
        ) {
    ...
    fn connect_workspace_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_workspace_trampoline<P: IsA<Client>, F: Fn(&P) + 'static>(
            this: *mut ffi::AstalHyprlandClient,
            _param_spec: glib::ffi::gpointer,
            f: glib::ffi::gpointer,
        ) {
    ...
    fn connect_floating_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_floating_trampoline<P: IsA<Client>, F: Fn(&P) + 'static>(
            this: *mut ffi::AstalHyprlandClient,
            _param_spec: glib::ffi::gpointer,
            f: glib::ffi::gpointer,
        ) {
        ...
        unsafe {
            ...
            connect_raw(
                self.as_ptr() as *mut _,
                c"notify::floating".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(
                    notify_floating_trampoline::<Self, F> as *const (),
                )),
                Box_::into_raw(f),
            )
        }
    ...
    fn connect_monitor_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_monitor_trampoline<P: IsA<Client>, F: Fn(&P) + 'static>(
            this: *mut ffi::AstalHyprlandClient,
            _param_spec: glib::ffi::gpointer,
            f: glib::ffi::gpointer,
        ) {
    ...
    fn connect_class_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_class_trampoline<P: IsA<Client>, F: Fn(&P) + 'static>(
            this: *mut ffi::AstalHyprlandClient,
            _param_spec: glib::ffi::gpointer,
            f: glib::ffi::gpointer,
        ) {
    ...
    fn connect_title_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_title_trampoline<P: IsA<Client>, F: Fn(&P) + 'static>(
            this: *mut ffi::AstalHyprlandClient,
            _param_spec: glib::ffi::gpointer,
            f: glib::ffi::gpointer,
        ) {
    ...
    fn connect_initial_class_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_initial_class_trampoline<
            P: IsA<Client>,
            F: Fn(&P) + 'static,
        >(
            this: *mut ffi::AstalHyprlandClient,
        ...
        unsafe {
            ...
            connect_raw(
                self.as_ptr() as *mut _,
                c"notify::initial-class".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(
                    notify_initial_class_trampoline::<Self, F> as *const (),
                )),
                Box_::into_raw(f),
            )
        }
    ...
    fn connect_initial_title_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_initial_title_trampoline<
            P: IsA<Client>,
            F: Fn(&P) + 'static,
        >(
            this: *mut ffi::AstalHyprlandClient,
        ...
        unsafe {
            ...
            connect_raw(
                self.as_ptr() as *mut _,
                c"notify::initial-title".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(
                    notify_initial_title_trampoline::<Self, F> as *const (),
                )),
                Box_::into_raw(f),
            )
        }
    ...
    fn connect_pid_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_pid_trampoline<P: IsA<Client>, F: Fn(&P) + 'static>(
            this: *mut ffi::AstalHyprlandClient,
            _param_spec: glib::ffi::gpointer,
            f: glib::ffi::gpointer,
        ) {
        ...
        unsafe {
            ...
            connect_raw(
                ...
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(
                    notify_pid_trampoline::<Self, F> as *const (),
                )),
                Box_::into_raw(f),
            )
        }
    ...
    fn connect_xwayland_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_xwayland_trampoline<P: IsA<Client>, F: Fn(&P) + 'static>(
            this: *mut ffi::AstalHyprlandClient,
            _param_spec: glib::ffi::gpointer,
            f: glib::ffi::gpointer,
        ) {
        ...
        unsafe {
            ...
            connect_raw(
                self.as_ptr() as *mut _,
                c"notify::xwayland".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(
                    notify_xwayland_trampoline::<Self, F> as *const (),
                )),
                Box_::into_raw(f),
            )
        }
    ...
    fn connect_pinned_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_pinned_trampoline<P: IsA<Client>, F: Fn(&P) + 'static>(
            this: *mut ffi::AstalHyprlandClient,
            _param_spec: glib::ffi::gpointer,
            f: glib::ffi::gpointer,
        ) {
    ...
    fn connect_fullscreen_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_fullscreen_trampoline<P: IsA<Client>, F: Fn(&P) + 'static>(
            this: *mut ffi::AstalHyprlandClient,
            _param_spec: glib::ffi::gpointer,
            f: glib::ffi::gpointer,
        ) {
        ...
        unsafe {
            ...
            connect_raw(
                self.as_ptr() as *mut _,
                c"notify::fullscreen".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(
    ...
    fn connect_fullscreen_client_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_fullscreen_client_trampoline<
            P: IsA<Client>,
            F: Fn(&P) + 'static,
        >(
            this: *mut ffi::AstalHyprlandClient,
        ...
        unsafe {
            ...
            connect_raw(
                self.as_ptr() as *mut _,
                c"notify::fullscreen-client".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(
                    notify_fullscreen_client_trampoline::<Self, F> as *const (),
                )),
                Box_::into_raw(f),
            )
        }
    ...
    fn connect_swallowing_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_swallowing_trampoline<P: IsA<Client>, F: Fn(&P) + 'static>(
            this: *mut ffi::AstalHyprlandClient,
            _param_spec: glib::ffi::gpointer,
            f: glib::ffi::gpointer,
        ) {
        ...
        unsafe {
            ...
            connect_raw(
                self.as_ptr() as *mut _,
                c"notify::swallowing".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(
                    notify_swallowing_trampoline::<Self, F> as *const (),
                )),
                Box_::into_raw(f),
            )
        }
    ...
    fn connect_focus_history_id_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_focus_history_id_trampoline<
            P: IsA<Client>,
            F: Fn(&P) + 'static,
        >(
            this: *mut ffi::AstalHyprlandClient,
        ...
        unsafe {
            ...
            connect_raw(
                self.as_ptr() as *mut _,
                c"notify::focus-history-id".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(
                    notify_focus_history_id_trampoline::<Self, F> as *const (),
                )),
                Box_::into_raw(f),
            )
        }
