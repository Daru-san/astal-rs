...
extern "C" {
    ...
    pub fn astal_power_profiles_power_profiles_hold_profile(
        self_: *mut AstalPowerProfilesPowerProfiles,
        profile: *const c_char,
        reason: *const c_char,
        application_id: *const c_char,
    ) -> c_int;
    pub fn astal_power_profiles_power_profiles_release_profile(
        self_: *mut AstalPowerProfilesPowerProfiles,
        cookie: c_uint,
    );
    pub fn astal_power_profiles_power_profiles_new() -> *mut AstalPowerProfilesPowerProfiles;
    pub fn astal_power_profiles_power_profiles_get_active_profile(
        self_: *mut AstalPowerProfilesPowerProfiles,
    ) -> *mut c_char;
    pub fn astal_power_profiles_power_profiles_set_active_profile(
        self_: *mut AstalPowerProfilesPowerProfiles,
        value: *const c_char,
    );
    pub fn astal_power_profiles_power_profiles_get_icon_name(
        self_: *mut AstalPowerProfilesPowerProfiles,
    ) -> *mut c_char;
    pub fn astal_power_profiles_power_profiles_get_actions(
        self_: *mut AstalPowerProfilesPowerProfiles,
        result_length1: *mut c_int,
    ) -> *mut *mut c_char;
    pub fn astal_power_profiles_power_profiles_get_active_profile_holds(
        self_: *mut AstalPowerProfilesPowerProfiles,
        result_length1: *mut c_int,
    ) -> *mut AstalPowerProfilesHold;
    pub fn astal_power_profiles_power_profiles_get_performance_degraded(
        self_: *mut AstalPowerProfilesPowerProfiles,
    ) -> *mut c_char;
    pub fn astal_power_profiles_power_profiles_get_profiles(
        self_: *mut AstalPowerProfilesPowerProfiles,
        result_length1: *mut c_int,
    ) -> *mut AstalPowerProfilesProfile;
    pub fn astal_power_profiles_power_profiles_get_version(
        self_: *mut AstalPowerProfilesPowerProfiles,
    ) -> *mut c_char;
