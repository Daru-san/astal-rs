...
const RUST_LAYOUTS: &[(&str, Layout)] = &[
    ...
    ("AstalNotifdActionClass", Layout {size: size_of::<AstalNotifdActionClass>(), alignment: align_of::<AstalNotifdActionClass>()}),
    ...
    ("AstalNotifdState", Layout {size: size_of::<AstalNotifdState>(), alignment: align_of::<AstalNotifdState>()}),
...
const RUST_CONSTANTS: &[(&str, &str)] = &[
    ...
    ("(gint) ASTAL_NOTIFD_STATE_DRAFT", "0"),
    ("(gint) ASTAL_NOTIFD_STATE_RECEIVED", "2"),
    ("(gint) ASTAL_NOTIFD_STATE_SENT", "1"),
