...
impl Layout {
    ...
    pub fn namespace(&self) -> Option<glib::GString> {
        unsafe { from_glib_none(ffi::astal_river_layout_get_namespace(self.to_glib_none().0)) }
    }
    ...
    pub fn connect_namespace_in_use<F: Fn(&Self, &Output) + 'static>(
        ...
        unsafe extern "C" fn namespace_in_use_trampoline<F: Fn(&Layout, &Output) + 'static>(
            this: *mut ffi::AstalRiverLayout,
            output: *mut ffi::AstalRiverOutput,
            f: glib::ffi::gpointer,
        ) {
        ...
        unsafe {
            ...
            connect_raw(
                ...
                c"namespace-in-use".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(
                    namespace_in_use_trampoline::<F> as *const (),
                )),
                Box_::into_raw(f),
            )
        }
    ...
    pub fn connect_user_command<F: Fn(&Self, &str, &Output) + 'static>(
        ...
        unsafe extern "C" fn user_command_trampoline<F: Fn(&Layout, &str, &Output) + 'static>(
            this: *mut ffi::AstalRiverLayout,
        ...
        unsafe {
            ...
            connect_raw(
                self.as_ptr() as *mut _,
                c"user-command".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(
                    user_command_trampoline::<F> as *const (),
                )),
                Box_::into_raw(f),
            )
        }
