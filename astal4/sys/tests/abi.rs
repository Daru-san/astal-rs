...
const RUST_LAYOUTS: &[(&str, Layout)] = &[
    ...
    (
        "AstalBin",
        Layout {
            size: size_of::<AstalBin>(),
            alignment: align_of::<AstalBin>(),
        },
    ),
    (
        "AstalBinClass",
        Layout {
            size: size_of::<AstalBinClass>(),
            alignment: align_of::<AstalBinClass>(),
        },
    ),
    (
        "AstalBox",
        Layout {
            size: size_of::<AstalBox>(),
            alignment: align_of::<AstalBox>(),
        },
    ),
    (
        "AstalBoxClass",
        Layout {
            size: size_of::<AstalBoxClass>(),
            alignment: align_of::<AstalBoxClass>(),
        },
    ),
    (
        "AstalExclusivity",
    ...
    (
        "AstalSlider",
        Layout {
            size: size_of::<AstalSlider>(),
            alignment: align_of::<AstalSlider>(),
        },
    ),
    (
        "AstalSliderClass",
        Layout {
            size: size_of::<AstalSliderClass>(),
            alignment: align_of::<AstalSliderClass>(),
        },
    ),
    (
        "AstalWindow",
